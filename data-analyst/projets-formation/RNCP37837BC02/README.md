...
- [Projet 4 - Réalisez une étude de santé publique avec R ou Python](./projet-04/)
- [Projet 6 - Optimisez la gestion des données d'une boutique avec R ou Python](./projet-06/)
- [Projet 8 - Analysez des indicateurs de l'égalité femmes-hommes en respect du RGPD](./projet-08/)
