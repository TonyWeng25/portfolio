...
Autonome et rigoureux, j'ai toujours été intéressé par le fait de manipuler les nombres et les données afin de leur donner un sens.
Durant mon parcours, j'ai appris à maitriser différents outils d'analyse, de visualisation et de valorisation de données tels que Python, SQL, Power BI...
